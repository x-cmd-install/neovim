...
[![x-cmd/install — neovim Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/neovim.svg?lang=zh)](https://x-cmd.com/install/neovim)
...
合计: **1,063,710** 行代码（覆盖前 5 种语言、共 **3475** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| VimScript | 412,062 | 21,795 | 20,844 | 2047 |
| Lua | 349,818 | 62,807 | 33,474 | 854 |
| C | 274,993 | 51,512 | 32,607 | 227 |
| CHeader | 16,647 | 3,458 | 3,077 | 304 |
...
- **Star**: 102,524 · **Fork**: 7,127 · **开放 issue**: 14,652 · **贡献者**: 1,917

## 累计统计

- **发布数**: 55 · **已合并 PR**: 20010 · **开放 PR**: 292 · **已关闭 issue**: 13024 · **开放 issue**: 1628 · **提交数**: 38199

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-24 | 1 | 283 | 49 | 76 | 64 | 386 |
| last60d | 2026-07-25 | 3 | 587 | 64 | 147 | 96 | 920 |
| 90d | 2026-06-25 | 4 | 908 | 77 | 242 | 130 | 1445 |
| last180d | 2026-03-27 | 9 | 1996 | 125 | 566 | 263 | 2836 |
| 360d | 2025-09-28 | 11 | 3505 | 167 | 1066 | 362 | 5409 |
| last720d | 2024-10-03 | 19 | 6271 | 207 | 2272 | 646 | 7451 |
...
neovim 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `neovim` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/neovim.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260923.yml` · 2026-09-23T04:37:45Z._
